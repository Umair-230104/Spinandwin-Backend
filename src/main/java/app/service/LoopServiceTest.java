...
public class LoopServiceTest {
    ...
    public LoopCustomersResponseDTO getCustomers(int pageNo, int limit)
            throws IOException, InterruptedException, URISyntaxException {
            ...
            while (true) {
                ...
                for (LoopSubscriptionDTO s : subsPage.getData()) {
                    ...
                    if (nextEpoch > 0) {
                        ...
                        System.out.println("nextBilling          : epoch=" + epochStr +
                                " | " + epochToCopenhagen(epochStr));
                    } else {
        ...
        try {
            ...
            while (true) {
                ...
                for (LoopCustomerDTO c : page.getData()) {
                    int activeCount = c.getActiveSubscriptionsCount() != null
                            ? c.getActiveSubscriptionsCount()
                            : 0;
