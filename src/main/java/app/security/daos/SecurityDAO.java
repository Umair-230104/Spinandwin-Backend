...
public class SecurityDAO implements ISecurityDAO {
    ...
    public User updateUser(String username, String newPassword) {
        try (EntityManager em = getEntityManager()) {
            ...
            e.printStackTrace();
            throw new ApiException(400, "Could not update user: " + e.getMessage());
        }
    }
    ...
    public List<UserDTO> getAllUsers() {
        try (EntityManager em = getEntityManager()) {
            ...
            return users.stream()
                    .map(u -> new UserDTO(u.getUsername(), u.getPassword(), u.getRolesAsStrings()))
    ...
    public void deleteUser(String username) {
        try (EntityManager em = getEntityManager()) {
            ...
            em.getTransaction().begin();
            // Fjern bruger fra alle roller først
            ...
            e.printStackTrace();
            throw new ApiException(400, "Could not delete user: " + e.getMessage());
        }
    }
