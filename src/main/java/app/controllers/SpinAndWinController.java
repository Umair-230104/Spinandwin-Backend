...
public class SpinAndWinController
{
    ...
    public SpinAndWinController(WheelSegmentDAO wheelSegmentDAO, CustomerEligibilityService eligibilityService, SpinService spinService)
    {
    ...
    public void checkEligibility(Context ctx)
    {
        try
        {
            ...
            EligibilityResponseDTO response = eligibilityService.checkEligibility(req.getEmailOrPhone());
